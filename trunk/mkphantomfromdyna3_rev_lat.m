function varargout=mkphantomfromdyna3_rev_lat(DYN_FILE,ZDISPFILE,OUTPUT_NAME,PPARAMS);
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% reverse the scatterers in the lateral dimenion for the flipped s/w sims
scatterers(:,2)=max(scatterers(:,2)) - scatterers(:,2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
