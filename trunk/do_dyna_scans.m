...
% Put all this in a try structure, so if something fails, field still
% ends gracefully.  Matlab 7 seems to abort if call field_init while
% field is running :(   
%try

% Start field w/o/ banner	
%field_init(-1);
